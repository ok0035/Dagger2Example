package com.example.dagger2test.test.case03
...
class MyModule {
    @Provides
    fun provideName(): String { //이름 제공
        return "Charles"
    }

    @Provides
    fun provideAge(): Int { //나이 제공
        return 100
    }

    @Provides
    fun providePerson(name: String, age: Int): Person { //이름, 나이 제공받음
        return Person(name, age) //name = Charles, age = 100
    }
}